...
export const AdvancedChatInterface: React.FC<AdvancedChatInterfaceProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Use the API URL from environment, with fallback for production
      ...
      if (error.name === 'AbortError') {
        ...
        errorMessageText = 'Unable to connect to the server. Please check your internet connection and make sure the backend is accessible.';
